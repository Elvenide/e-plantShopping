                        ...
                        <div key={index} className="product-list">
                            ...
                            {category.plants.map((plant, pIndex) => (
                                <div key={pIndex} className="product-card">
                                    ...
                                    <button className="product-button" onClick={() => handleAddToCart(plant)} disabled={isInCart(plant)}>{isInCart(plant) ? "Added to Cart" : "Add to Cart"}</button>
                                </div>
                            ))}
                        </div>
                    ))}
